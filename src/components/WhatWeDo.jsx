...
export default function WhatWeDo() {
  return (
    <div className='whatWeDo container ptb'> 
        ...
        <h3 className='subheadWord'>We provide highly commendable ATM related services to all business sizes, from start-ups to enterprise-level organizations.</h3>
        <div className="serviceDet">
          <div className="col-6 col-lg-6 col-sm-12 col-md-6 serviceCopy">
            <h4>We provide highly commendable ATM related services. We are ATM specialists. You can always trust us with any ATM related work.</h4>
